...
from robomimic.act.utils import load_data 
from robomimic.act.utils import compute_dict_mean, set_seed, detach_dict
from robomimic.act.utils import cleanup_ckpt, get_last_ckpt
from robomimic.act.utils import cosine_schedule_with_warmup, cosine_schedule
from robomimic.act.policy import ACTPolicy, ViTPolicy, DecOnlyPolicy
from robomimic.act.eval import Evaluator
...
if __name__ == '__main__':
    ...
    config['ckpt_dir'] = os.path.join("./checkpoints", name)
